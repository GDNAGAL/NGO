    ...
    <div class="bg-white shadow p-4 rounded-3">
      ...
      <div class="table-responsive">
        <table class="table table-hover" id="userTable">
          <thead>
            <tr>
              <th scope="col" class="no-wrap">User ID</th>
              <th scope="col">Full Name</th>
              <th scope="col">Email</th>
              <th scope="col">Mobile No</th>
              <th scope="col" class="no-wrap">DOB</th>
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                  ...
                  if($row['isAdmin']){
                    ...
                    echo "<td>" . htmlspecialchars($row['MobileNo']). ($row['isMobileVerified']?"<i class='bi bi-check-circle-fill ms-2 text-success'></i>":"<i class='bi bi-exclamation-circle-fill ms-2 text-warning'></i>") . "</td>";
