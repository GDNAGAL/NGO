          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="mb-3">
                ...
                <input type="file" class="form-control" name="storyimage" required>
              </div>
            </div>
          </div>
          <div class="mb-3">
            <label for="fullname" class="form-label">Enter Title</label>
            <textarea type="text" rows="15" class="form-control" id="fullname" name="story" required></textarea>
          </div>
          <div class="d-flex justify-content-end">
            <button type="button" class="btn btn-secondary me-2 shadow-none" data-bs-dismiss="modal">Close</button>
            <button type="submit" name="addStory" class="btn btn-primary shadow-none">Save Changes</button>
          </div>
        </form>
      </div>
    </div>
